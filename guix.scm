;; resource-record-fluctuator - Guix Package Definition
...
(define-public resource_record_fluctuator
  (package
    (name "resource-record-fluctuator")
    (version "0.1.0")
    (source (local-file "." "resource-record-fluctuator-checkout"
                        #:recursive? #t
